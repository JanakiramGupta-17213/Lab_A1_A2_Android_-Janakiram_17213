...
public class ProductEntryActivity extends AppCompatActivity {
    ...
    EditText et_productid, et_productname, et_productdesc, et_productprice, et_providername, et_provideremail,
            et_providerphone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(prodid!=0)
        {
            ...
            et_providername.setText(String.valueOf(allproducts.getProvidername()));
            et_provideremail.setText(String.valueOf(allproducts.getProvideremail()));
            et_providerphone.setText(String.valueOf(allproducts.getProviderphone()));

            latitude = allproducts.getLatitude();
            longitude = allproducts.getLongitude();
        ...
        tv_prodsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (et_providername.getText().toString().equals("")) {
                    et_providername.setError("Please Enter a Provider Name");
                } else if (et_provideremail.getText().toString().equals("")) {
                    et_provideremail.setError("Please Enter Provider's Email");
                } else if (et_providerphone.getText().toString().equals("")) {
                    et_providerphone.setError("Please Enter Provider's Phone No");
                ...
                else if(prodid == 0 && uid.contains(Integer.parseInt(et_productid.getText().toString())))
                {
                    ...
                    Product product = new Product(Integer.parseInt(et_productid.getText().toString()),
                            ...
                            et_providername.getText().toString().toLowerCase(), et_provideremail.getText().toString(),
                            Long.parseLong(et_providerphone.getText().toString()), latitude, longitude);
