...
public class ViewProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // getting product id using provider name from room database
        product_uid = pdtdb.productDao().loadAlluidsByProvidernames(provider_name);

        // getting product names using provider name from room database
        product_name = pdtdb.productDao().loadAllProductsByProvidernames(provider_name);

        // getting product descriptions using provider name from room database
        product_price = pdtdb.productDao().loadAllPriceByProvidernames(provider_name);
